    ...
    try {
      ...
      await db.transaction("rw", [db.media, db.sessions, db.results, db.places, db.appState], async () => {
        ...
        await db.results.put({
          ...
          isFavorite: false,
          isMemorial,
          setupNameSnapshot: currentSetup.name,
          primaryItemNameSnapshot: currentPrimaryItem?.name,
          riverNameSnapshot: currentPlace.riverName,
          areaNameSnapshot: currentPlace.areaName,
          pointNameSnapshot: currentPlace.pointName,
